...
//Attributes
	...
	private Table2Set<Integer,Integer> InfluenceMap; //Class -> Its Influence Classes
...
//Constructors
	...
	public RelationshipMap()
	{
		...
		InfluenceMap=new Table2Set<Integer,Integer>();
	}
...
//Public Methods
	...
	/**
	 * Adds a new influence relations between two classes
	 * @param class1: the index of the first influence class
	 * @param class2: the index of the second influence class
	 */
	public void addInfluence(int class1, int class2)
	{
		if(class1 != class2 && !areDisjoint(class1,class2))
		{
			//The disjointMap keeps disjoint clauses in both directions
			InfluenceMap.add(class1, class2);
			InfluenceMap.add(class2, class1);
		}
	}
	...
	public Set<Integer> getInfluence()
	{
		return InfluenceMap.keySet();
	}
	...
	public Set<Integer> getInfluence(int classId)
	{
		if(InfluenceMap.contains(classId))
			return InfluenceMap.get(classId);
		return new HashSet<Integer>();
	}
	...
	public boolean hasInfluence(int classId)
	{
		return InfluenceMap.contains(classId);
	}
	...
	public boolean hasInfluenceClause(int one, int two)
	{
		return (InfluenceMap.contains(one) && InfluenceMap.contains(one,two));
	}
