...
//Public Methods
	...
	public void repairByGraph()
	{
		...
		r.obtainReliableMappings();  //obtain reliable mappings
		...
		//r.ArcByGuaranteedRevisedMappings();
		
		//r.ArcByNormedRevisedMappings();
		
		//r.GraphRevisedMappingsCompleteByStrutureFunction();	
		
		//r.GraphRevisedMappingsCompleteByOptimalFunction();
		
		r.GraphRevisedMappingsCompleteByWeightPlus();	
		...
		//r.AutoBasedReferenceAlignmentAutoArcByGuaranteed();
		
		//r.AutoBasedReferenceAlignmentArcByNormed();
			
		//r.AutoBasedRefAlignByGraphRevisedMappingStrutureFunction();
				
		//r.AutoBasedRefAlignByGraphRevisedMappingOptimalFunction();
		
		//r.AutoBasedRefAlignByGraphRevisedMappingWeightPlus();
		
		
		
		//r.AutoBasedReferenceAlignmentSimpleAutoGraphRepair();	//reduce the time consumption
